...
const SignUp = () => {
    const { register, handleSubmit, reset } = useForm<FormSingup>()
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div>
                            ...
                            <div className="mt-2">
                                <input  {...register("name", { required: true })} id="name" name="name" type="name" autoComplete="name" required className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                            </div>
                        </div>
                    ...
                    <p className="mt-10 text-center text-sm text-gray-500">
                        Đã có mật tài khoản ?
                        <Link href="/sign-in" className="font-semibold leading-6 text-black hover:text-indigo-500">Login</Link>
                    </p>
                </div>
            </div>
        </div>
